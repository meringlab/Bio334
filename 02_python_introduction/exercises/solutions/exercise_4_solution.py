...
## Exercise 4.1 Create the pipeline script (Check the inputs)
#

# run zour script analyse_microbial_samples.py from the terminal: 
# ipython analyse_microbial_samples.py <body site> <dataset path> <output path>
# replace the script name if needed, eg. to exercise_4_solution.py if you run this exact solution
...
#### Exercise 4.3 General data set statistics
...
# place "exercise_4_solution.py" in
# ./02_python_introduction/exercises/files/exercise_4/ location or adapt file path below
...
### Exercise 4.4 Microbial interactions
