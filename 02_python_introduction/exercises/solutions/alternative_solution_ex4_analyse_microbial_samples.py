...
parser.add_argument('--sample_dir','-sd',help="the path to the samples directory (default:'../Human_Microbiome_project/')", default='files/exercise_4/Human_Microbiome_project/')
