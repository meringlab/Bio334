...
# this script expects to be in the exercise folder
# run it in the terminal for example like this: 
# python alternative_solution_ex4_analyse_microbial_samples.py --body_site Oral --sample_dir files/exercise_4/Human_Microbiome_project/ --output_path ./results
...
parser = argparse.ArgumentParser(description='Bio334 Exercise 4.')
...
parser.add_argument('--sample_dir','-sd',help="the path to the samples directory (default:'files/exercise_4/Human_Microbiome_project/')", default='files/exercise_4/Human_Microbiome_project/')
...
id_path = "files/exercise_4/microbe_identifiers.txt"
...
script = "files/exercise_4/compute_microbial_interactions.py"
...
pwi = np.genfromtxt('files/exercise_4/pairwise_interaction_strengths.txt')
min_max_pwi = []
